...
namespace Salary_management.Migrations
{
    ...
    [Migration("20220919100230_UpdateQualification")]
    partial class UpdateQualification
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Salary_management.Infrastructure.Entities.RewardOrDiscipline", b =>
                {
                    ...
                    b.HasIndex("StaffId")
                        .HasDatabaseName("ix_reward_or_disciplines_staff_id");
            ...
            modelBuilder.Entity("Salary_management.Infrastructure.Entities.StaffQualification", b =>
                {
                    b.Property<string>("StaffId")
                        .HasColumnType("character varying(255)")
                        .HasColumnName("staff_id");
                    ...
                    b.HasKey("StaffId", "QualificationId")
                        .HasName("pk_staff_qualifications");

                    b.HasIndex("QualificationId")
                        .HasDatabaseName("ix_staff_qualifications_qualification_id");
            ...
            modelBuilder.Entity("Salary_management.Infrastructure.Entities.RewardOrDiscipline", b =>
                {
                    b.HasOne("Salary_management.Infrastructure.Entities.Staff", "Staff")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reward_or_disciplines_staffs_staff_id");
            ...
            modelBuilder.Entity("Salary_management.Infrastructure.Entities.StaffQualification", b =>
                {
                    b.HasOne("Salary_management.Infrastructure.Entities.Qualification", "Qualification")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_staff_qualifications_qualifications_qualification_id");
                    ...
                    b.HasOne("Salary_management.Infrastructure.Entities.Staff", "Staff")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_staff_qualifications_staffs_staff_id");
